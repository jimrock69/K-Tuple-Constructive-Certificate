...
\end{equation}
Because $k_{eff} = 0$ for all steps up to $p=7$, the negative filtration terms vanish entirely during the initial expansion. This generates a massive local candidate surplus that accelerates computational search times, a phenomenon empirically verified by the deep-search discoveries recorded in Section 11. Supplement.
